# Smart Home Manager - Backend API

A comprehensive GraphQL API for managing home inventory, meal planning, expense tracking, and more.
...
- 📊 **Analytics & Reports** - Comprehensive insights into home usage
