...
import { houseResolvers } from './house';
  ...
  InventoryItem: {
    ...
    totalQuantity: async (parent: any, _: any, context: any) => {
      try {
        ...
        console.error('Error calculating totalQuantity for item', parent.id, ':', error);
        return 0;
      }
    },
    status: async (parent: any, _: any, context: any) => {
      try {
        ...
        console.error('Error calculating status for item', parent.id, ':', error);
        return 'OK';
      }
    },
    nextExpiry: async (parent: any, _: any, context: any) => {
      try {
        ...
        console.error('Error getting nextExpiry for item', parent.id, ':', error);
        return null;
      }
    },
  },
