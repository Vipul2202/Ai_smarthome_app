...
const FROM_EMAIL = process.env.FROM_EMAIL || 'Smart Home <noreply@your-domain.com>';
...
export class EmailService {
  ...
  private static getWelcomeEmailTemplate(userName: string): EmailTemplate {
    return {
      subject: '🎉 Welcome to Smart Home Manager!',
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
          <div style="text-align: center; margin-bottom: 30px;">
            <h1 style="color: #10b981; margin: 0;">🏠 Smart Home Manager</h1>
          </div>
          ...
          <div style="background: linear-gradient(135deg, #10b981, #059669); color: white; padding: 30px; border-radius: 12px; text-align: center; margin-bottom: 30px;">
            ...
            <p style="margin: 0; opacity: 0.9;">Your smart home management journey starts now!</p>
          </div>
          ...
          <div style="background: #f8fafc; padding: 25px; border-radius: 8px; margin-bottom: 25px;">
            ...
            <ul style="color: #4b5563; line-height: 1.6;">
              ...
              <li>📊 Monitor your home analytics</li>
            </ul>
          </div>
      ...
      `,
      text: `
        Welcome to Smart Home Manager, ${userName}!
        
        Your smart home management journey starts now!
  ...
  private static getPasswordResetEmailTemplate(resetUrl: string): EmailTemplate {
    return {
      subject: '🔐 Reset Your Smart Home Manager Password',
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
          <div style="text-align: center; margin-bottom: 30px;">
            <h1 style="color: #10b981; margin: 0;">🏠 Smart Home Manager</h1>
      ...
      `,
      text: `
        Smart Home Manager - Password Reset Request
  ...
  private static getEmailVerificationTemplate(verificationUrl: string): EmailTemplate {
    return {
      subject: '✅ Verify Your Smart Home Manager Email',
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
          <div style="text-align: center; margin-bottom: 30px;">
            <h1 style="color: #10b981; margin: 0;">🏠 Smart Home Manager</h1>
      ...
      `,
      text: `
        Smart Home Manager - Email Verification
  ...
  private static getLowStockAlertTemplate(
    ...
    return {
      subject: '⚠️ Low Stock Alert - Smart Home Manager',
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
          <div style="text-align: center; margin-bottom: 30px;">
            <h1 style="color: #10b981; margin: 0;">🏠 Smart Home Manager</h1>
          ...
          <div style="background: #fef2f2; border: 1px solid #ef4444; padding: 20px; border-radius: 8px; margin-bottom: 25px;">
            ...
            <p style="color: #dc2626; margin-bottom: 0;">Hi ${userName}, some items in your home are running low!</p>
          </div>
      ...
      `,
      text: `
        Low Stock Alert - Smart Home Manager
        
        Hi ${userName}, some items in your home are running low!
  ...
  private static getExpiryAlertTemplate(
    ...
    return {
      subject: '⏰ Items Expiring Soon - Smart Home Manager',
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
          <div style="text-align: center; margin-bottom: 30px;">
            <h1 style="color: #10b981; margin: 0;">🏠 Smart Home Manager</h1>
          ...
          <div style="background: #fef3c7; border: 1px solid #f59e0b; padding: 20px; border-radius: 8px; margin-bottom: 25px;">
            ...
            <p style="color: #92400e; margin-bottom: 0;">Hi ${userName}, some items in your home are expiring soon!</p>
          </div>
      ...
      `,
      text: `
        Items Expiring Soon - Smart Home Manager
        
        Hi ${userName}, some items in your home are expiring soon!
  ...
  private static getShoppingReminderTemplate(
    ...
    return {
      subject: '🛒 Shopping Reminder - Smart Home Manager',
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
          <div style="text-align: center; margin-bottom: 30px;">
            <h1 style="color: #10b981; margin: 0;">🏠 Smart Home Manager</h1>
      ...
      `,
      text: `
        Shopping Reminder - Smart Home Manager
  ...
  private static getSecurityAlertTemplate(userName: string, alertType: string, details: string): EmailTemplate {
    return {
      subject: '🔒 Security Alert - Smart Home Manager',
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
          <div style="text-align: center; margin-bottom: 30px;">
            <h1 style="color: #10b981; margin: 0;">🏠 Smart Home Manager</h1>
      ...
      `,
      text: `
        Security Alert - Smart Home Manager
